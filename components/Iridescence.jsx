...
export default function Iridescence({
  ...
  const resolvedColorKey = Array.isArray(resolvedColor)
    ? resolvedColor.join(',')
    : String(resolvedColor);
  const resolvedMouseReact = mouseInteraction ?? mouseReact;
  ...
  }, [resolvedColorKey, speed, amplitude, resolvedMouseReact]);
