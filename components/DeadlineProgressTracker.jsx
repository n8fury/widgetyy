...
const DeadlineProgressTracker = () => {
  ...
  useEffect(() => {
    ...
    // Check for embed mode - hide settings if embed=true
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      >
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                title="Hide settings (click gear icon to show again)"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
        ...
        {/* Floating Edit Button - shown when settings are hidden */}
        {!showSettings && (
          <button
            onClick={() => setShowSettings(true)}
            className="fixed top-4 right-4 p-3 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 text-gray-600 hover:text-blue-500 z-50"
